...
convert-waterdeep:
	...
	./src/R20Converter.py $(CONVERT_FLAGS) waterdeep-demo "waterdeep demo.zip"
convert-lmop:
	@rm -rf LMoP
	./src/R20Converter.py $(CONVERT_FLAGS) LMoP "The Lost Mine of Phandelver.zip"
convert-cos:
	@rm -rf curse-of-strahd
	./src/R20Converter.py $(CONVERT_FLAGS) curse-of-strahd "Curse of Strahd.zip"
